...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Event'
        db.create_table('cbeamd_event', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uid', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('start', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('end', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('cbeamd', ['Event'])

        # Adding field 'User.autologout'
        db.add_column('cbeamd_user', 'autologout',
                      self.gf('django.db.models.fields.IntegerField')(default=600),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Event'
        db.delete_table('cbeamd_event')

        # Deleting field 'User.autologout'
        db.delete_column('cbeamd_user', 'autologout')
