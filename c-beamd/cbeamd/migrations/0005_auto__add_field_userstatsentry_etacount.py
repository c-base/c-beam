...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserStatsEntry.etacount'
        db.add_column('cbeamd_userstatsentry', 'etacount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserStatsEntry.etacount'
        db.delete_column('cbeamd_userstatsentry', 'etacount')
