...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MissionLog'
        db.create_table('cbeamd_missionlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mission', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cbeamd.Mission'], unique=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cbeamd.User'], unique=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('cbeamd', ['MissionLog'])

        # Adding field 'User.ap'
        db.add_column('cbeamd_user', 'ap',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MissionLog'
        db.delete_table('cbeamd_missionlog')

        # Deleting field 'User.ap'
        db.delete_column('cbeamd_user', 'ap')
