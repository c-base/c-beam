...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mission.repeat_after_days'
        db.add_column('cbeamd_mission', 'repeat_after_days',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mission.repeat_after_days'
        db.delete_column('cbeamd_mission', 'repeat_after_days')
