...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityLog.protests'
        db.add_column('cbeamd_activitylog', 'protests',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ActivityLog.ap_protests'
        db.add_column('cbeamd_activitylog', 'ap_protests',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ActivityLog.thanks'
        db.add_column('cbeamd_activitylog', 'thanks',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityLog.protests'
        db.delete_column('cbeamd_activitylog', 'protests')

        # Deleting field 'ActivityLog.ap_protests'
        db.delete_column('cbeamd_activitylog', 'ap_protests')

        # Deleting field 'ActivityLog.thanks'
        db.delete_column('cbeamd_activitylog', 'thanks')
