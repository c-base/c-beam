...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityLogComment'
        db.create_table('cbeamd_activitylogcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=4000)),
            ('comment_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('cbeamd', ['ActivityLogComment'])

        # Adding M2M table for field comment on 'ActivityLog'
        db.create_table('cbeamd_activitylog_comment', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activitylog', models.ForeignKey(orm['cbeamd.activitylog'], null=False)),
            ('activitylogcomment', models.ForeignKey(orm['cbeamd.activitylogcomment'], null=False))
        ))
        db.create_unique('cbeamd_activitylog_comment', ['activitylog_id', 'activitylogcomment_id'])


    def backwards(self, orm):
        # Deleting model 'ActivityLogComment'
        db.delete_table('cbeamd_activitylogcomment')

        # Removing M2M table for field comment on 'ActivityLog'
        db.delete_table('cbeamd_activitylog_comment')
    ...
    models = {
        ...
        'cbeamd.activitylog': {
            ...
            'ap_protests': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'comment': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['cbeamd.ActivityLogComment']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
