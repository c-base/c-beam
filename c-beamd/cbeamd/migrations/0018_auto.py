...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field comments on 'ActivityLog'
        db.create_table('cbeamd_activitylog_comments', (
        ...
        db.create_unique('cbeamd_activitylog_comments', ['activitylog_id', 'activitylogcomment_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field comments on 'ActivityLog'
        db.delete_table('cbeamd_activitylog_comments')
