...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mission.completed_on'
        db.add_column('cbeamd_mission', 'completed_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mission.completed_on'
        db.delete_column('cbeamd_mission', 'completed_on')
