...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.push_missions'
        db.add_column('cbeamd_user', 'push_missions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'User.push_boarding'
        db.add_column('cbeamd_user', 'push_boarding',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'User.push_eta'
        db.add_column('cbeamd_user', 'push_eta',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.push_missions'
        db.delete_column('cbeamd_user', 'push_missions')

        # Deleting field 'User.push_boarding'
        db.delete_column('cbeamd_user', 'push_boarding')

        # Deleting field 'User.push_eta'
        db.delete_column('cbeamd_user', 'push_eta')
