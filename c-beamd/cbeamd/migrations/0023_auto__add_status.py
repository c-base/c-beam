...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Status'
        db.create_table('cbeamd_status', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bar_open', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('airlock_stripe_mode', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('airlock_volume', self.gf('django.db.models.fields.IntegerField')(default=42)),
        ))
        db.send_create_signal('cbeamd', ['Status'])


    def backwards(self, orm):
        # Deleting model 'Status'
        db.delete_table('cbeamd_status')
    ...
    models = {
        ...
        'cbeamd.status': {
            ...
            'airlock_stripe_mode': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'airlock_volume': ('django.db.models.fields.IntegerField', [], {'default': '42'}),
            'bar_open': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'cbeamd.subscription': {
        ...
        'cbeamd.user': {
            ...
            'push_boarding': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'push_eta': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'push_missions': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'rfid': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'stats_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
