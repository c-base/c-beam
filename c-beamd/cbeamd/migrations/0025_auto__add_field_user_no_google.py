...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.no_google'
        db.add_column('cbeamd_user', 'no_google',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.no_google'
        db.delete_column('cbeamd_user', 'no_google')
    ...
    models = {
        ...
        'cbeamd.user': {
            ...
            'no_google': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'stealthmode': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'username': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
